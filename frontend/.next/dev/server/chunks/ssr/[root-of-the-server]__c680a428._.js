...
async function loginAdmin({ email, password }) {
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/api/auth/login", payload, {
            headers: {
...
function Login() {
    ...
    const loginHandler = async (e)=>{
        e.preventDefault();
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authServices$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginAdmin"])({
            email,
            password
        });
        if (response.code === 200) {
            //   localStorage.setItem("login", "yes")
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["redirect"])("admin/dashboard");
        } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c680a428._.js.map