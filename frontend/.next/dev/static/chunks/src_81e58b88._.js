...
"[project]/src/app/admin/links/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LinksPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LinksPage.useEffect": ()=>{
            const check = {
                "LinksPage.useEffect.check": async ()=>{
                    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$linkService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllLinks"])();
                    if (res.data.status === "ok") {
                        setLinks(res.data.data);
                        setLoading(false);
                    }
                }
            }["LinksPage.useEffect.check"];
            check();
        }
    }["LinksPage.useEffect"], []);
    if (loading) {
...
_s(LinksPage, "82v5DKYHAKy7xQnxs6smg6MvCZg=");
_c = LinksPage;
var _c;
...
//# sourceMappingURL=src_81e58b88._.js.map